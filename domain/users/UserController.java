...
public class UserController {
    ...
    public Response<?> findAll() {
        return new Response<>("true", "조회성공", userRepository.findAll());
    }
    ...
    public Response<?> findUser(@PathVariable("id") Integer id) {
        return new Response<>("true", "조회 성공", userRepository.findById(id).orElseThrow(() -> new IllegalArgumentException("User not found")));
    }
